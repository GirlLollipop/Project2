...
import { Route, Switch, Link } from "react-router-dom"; //hay que importar Route y switch ya que los ocuparemos
  ...
  render() {
    ...
    return (
      ...
      <Switch> //entre los switch escribimos los componentes que van a hacer un "cambio de vista"
        ...
        <Route component={ModalMap} path="/ModalMap" />
      ...
      <div className="container">
            <li className="text-footer footer-link"> <Link className="twhite" to="/">Sucursales</Link> </li>
